            ...
            <div className="flex flex-1 flex-col lg:flex-row items-center justify-center gap-4 py-10 lg:py-0">
                <div className="flex flex-col flex-1/2 items-center justify-center">
                    <div className="text-center mb-8">
                        <h1 className="text-2xl md:text-5xl text-left font-medium text-gray-800">A gente lembra. Você segue em frente</h1>
                        <ul className="flex flex-col gap-4 text-gray-600 mt-4 md:grid md:grid-cols-2">
                            <li>
                                <div className="flex flex-row items-start gap-1">
                                    <CheckIcon className="size-4 mt-1 text-blue-500" />
                    ...
                    <div className="w-full">
                        <div className="w-full  lg:w-3/4 sticky top-0 bg-background z-10 pt-4 pb-1">
                ...
                <div className="flex w-full h-2/3 lg:flex-1/2 items-center justify-center">
                    <div className="bg-amber-100 w-full h-full rounded-xl">
